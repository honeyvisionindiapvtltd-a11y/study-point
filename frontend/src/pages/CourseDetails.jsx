...
const courseDetails = {
 ...
 "cbse-courses": { overview: "Focused CBSE coaching that builds strong fundamentals and prepares students for school examinations with confidence.", subjects: "CBSE curriculum and all subjects", support: "Chapter revision, regular assessments and personalized attention." },
 "icse-courses": { overview: "Detailed ICSE subject guidance with clear explanations, guided practice and support throughout the academic year.", subjects: "ICSE curriculum and all subjects", support: "Detailed study material, doubt support and performance analysis." },
